...
class FocusFetchData(IFetchData):
    ...
    def build_url(self, indicator: str, date: str, temporal_series:str) -> str:
        ...
        if not date or not indicator or not temporal_series:
            raise ValueError("`dt_referencia`, `indicador` e `serie_temporal` são obrigatórios para construir a URL.")
...
class MoedasFetchData(IFetchData):
    ...
    def fetch_data(self, date: str) -> dict:
        ...
        try:
            ...
            headers = ['data', 'cod', 'tipo', 'moeda', 'taxa_compra', 'taxa_venda', 'paridade_compra', 'paridade_venda']
            list_of_dicts = []
            for row in reader:
...
class TesouroFetchData(IFetchData):
    ...
    def fetch_data(self, date: str) -> dict:
        ...
        try:
            ...
            headers = [
                'tp_titulo', 'dt_vencimento', 'dt_base',
...
if __name__ == "__main__":
    ...
    data = focus.fetch_data(indicator="Selic", date="31/10/2025", temporal_series="anual")
    print(data)
